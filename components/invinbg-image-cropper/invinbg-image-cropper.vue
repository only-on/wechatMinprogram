<template>
    <view class="vue-cropper" ref="cropper" :style="{ top : `${containerTop}px` }" v-show="show">
        ...
        <view class="uni-info__ft">
            <view class="uni-modal__btn uni-modal__btn_default" style="color: rgb(0, 0, 0); height: 80upx; line-height: 80upx;" @tap="cancel">取消</view>
            <view class="uni-modal__btn uni-modal__btn_primary" style="color: rgb(0, 122, 255); height: 80upx; line-height: 80upx;" @tap="confirm">确定</view>
        </view>
    </view>
</template>
